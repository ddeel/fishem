...
"""
ActionInfo API Definitions.

Defines REST API behaviors for ActionInfo.
...
class ActionInfo(Resource):
    """Defines API behaviors for ActionInfo instances.
...
class ActionInfoActions(Resource):
    """Defines API behaviors for ActionInfo Actions.
