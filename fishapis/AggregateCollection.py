...
"""
AggregateCollection API Definitions.

Defines REST API behaviors for AggregateCollection.
...
class AggregateCollection(Resource):
    """Defines API behaviors for AggregateCollection.
