...
"""
AggregationSourceCollection API Definitions.

Defines REST API behaviors for AggregationSourceCollection.
...
class AggregationSourceCollection(Resource):
    """Defines API behaviors for AggregationSourceCollection.
