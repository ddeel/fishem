...
"""
ComputerSystemCollection API Definitions.

Defines REST API behaviors for ComputerSystemCollection.
...
class ComputerSystemCollection(Resource):
    """Defines API behaviors for ComputerSystemCollection.
