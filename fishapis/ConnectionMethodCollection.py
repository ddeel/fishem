...
"""
ConnectionMethodCollection API Definitions.

Defines REST API behaviors for ConnectionMethodCollection.
...
class ConnectionMethodCollection(Resource):
    """Defines API behaviors for ConnectionMethodCollection.
