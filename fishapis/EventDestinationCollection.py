...
"""
EventDestinationCollection API Definitions.

Defines REST API behaviors for EventDestinationCollection.
...
class EventDestinationCollection(Resource):
    """Defines API behaviors for EventDestinationCollection.
