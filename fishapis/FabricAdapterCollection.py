...
"""
FabricAdapterCollection API Definitions.

Defines REST API behaviors for FabricAdapterCollection.
...
class FabricAdapterCollection(Resource):
    """Defines API behaviors for FabricAdapterCollection.
