...
"""
FabricCollection API Definitions.

Defines REST API behaviors for FabricCollection.
...
class FabricCollection(Resource):
    """Defines API behaviors for FabricCollection.
