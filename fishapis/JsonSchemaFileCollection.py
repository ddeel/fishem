...
"""
JsonSchemaFileCollection API Definitions.

Defines REST API behaviors for JsonSchemaFileCollection.
...
class JsonSchemaFileCollection(Resource):
    """Defines API behaviors for JsonSchemaFileCollection.
