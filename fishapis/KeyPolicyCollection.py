...
"""
KeyPolicyCollection API Definitions.

Defines REST API behaviors for KeyPolicyCollection.
...
class KeyPolicyCollection(Resource):
    """Defines API behaviors for KeyPolicyCollection.
