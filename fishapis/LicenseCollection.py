...
"""
LicenseCollection API Definitions.

Defines REST API behaviors for LicenseCollection.
...
class LicenseCollection(Resource):
    """Defines API behaviors for LicenseCollection.
