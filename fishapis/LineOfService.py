...
"""
LineOfService API Definitions.

Defines REST API behaviors for LineOfService.
...
class LineOfService(Resource):
    """Defines API behaviors for LineOfService instances.
...
class LineOfServiceActions(Resource):
    """Defines API behaviors for LineOfService Actions.
