...
"""
LineOfServiceCollection API Definitions.

Defines REST API behaviors for LineOfServiceCollection.
...
class LineOfServiceCollection(Resource):
    """Defines API behaviors for LineOfServiceCollection.
