...
"""
MessageRegistry API Definitions.

Defines REST API behaviors for MessageRegistry.
...
class MessageRegistry(Resource):
    """Defines API behaviors for MessageRegistry instances.
...
class MessageRegistryActions(Resource):
    """Defines API behaviors for MessageRegistry Actions.
