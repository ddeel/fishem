...
"""
MessageRegistryCollection API Definitions.

Defines REST API behaviors for MessageRegistryCollection.
...
class MessageRegistryCollection(Resource):
    """Defines API behaviors for MessageRegistryCollection.
