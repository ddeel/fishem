...
"""
MetricDefinitionCollection API Definitions.

Defines REST API behaviors for MetricDefinitionCollection.
...
class MetricDefinitionCollection(Resource):
    """Defines API behaviors for MetricDefinitionCollection.
