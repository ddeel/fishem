...
"""
NVMeDomainCollection API Definitions.

Defines REST API behaviors for NVMeDomainCollection.
...
class NVMeDomainCollection(Resource):
    """Defines API behaviors for NVMeDomainCollection.
