...
"""
PrivilegeRegistry API Definitions.

Defines REST API behaviors for PrivilegeRegistry.
...
class PrivilegeRegistry(Resource):
    """Defines API behaviors for PrivilegeRegistry instances.
...
class PrivilegeRegistryActions(Resource):
    """Defines API behaviors for PrivilegeRegistry Actions.
