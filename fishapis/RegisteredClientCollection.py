...
"""
RegisteredClientCollection API Definitions.

Defines REST API behaviors for RegisteredClientCollection.
...
class RegisteredClientCollection(Resource):
    """Defines API behaviors for RegisteredClientCollection.
