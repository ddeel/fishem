...
"""
ResourceBlockCollection API Definitions.

Defines REST API behaviors for ResourceBlockCollection.
...
class ResourceBlockCollection(Resource):
    """Defines API behaviors for ResourceBlockCollection.
