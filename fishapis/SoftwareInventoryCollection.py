...
"""
SoftwareInventoryCollection API Definitions.

Defines REST API behaviors for SoftwareInventoryCollection.
...
class SoftwareInventoryCollection(Resource):
    """Defines API behaviors for SoftwareInventoryCollection.
