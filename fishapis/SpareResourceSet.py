...
"""
SpareResourceSet API Definitions.

Defines REST API behaviors for SpareResourceSet.
...
class SpareResourceSet(Resource):
    """Defines API behaviors for SpareResourceSet instances.
...
class SpareResourceSetActions(Resource):
    """Defines API behaviors for SpareResourceSet Actions.
