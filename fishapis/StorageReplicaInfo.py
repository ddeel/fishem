...
"""
StorageReplicaInfo API Definitions.

Defines REST API behaviors for StorageReplicaInfo.
...
class StorageReplicaInfo(Resource):
    """Defines API behaviors for StorageReplicaInfo instances.
...
class StorageReplicaInfoActions(Resource):
    """Defines API behaviors for StorageReplicaInfo Actions.
