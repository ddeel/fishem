...
"""
TriggersCollection API Definitions.

Defines REST API behaviors for TriggersCollection.
...
class TriggersCollection(Resource):
    """Defines API behaviors for TriggersCollection.
